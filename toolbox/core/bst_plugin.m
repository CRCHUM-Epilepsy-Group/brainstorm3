...
PlugDesc(end).ExtraMenus     = {...
    'SpikeNet Description', 'web(''https://jamanetwork.com/journals/jamaneurology/fullarticle/2752666'', ''-browser'')';...
    'Step 1 - Preprocessing', 'step1_preprocess';...
    'Step 2 - Running SpikeNet', 'step2_runSpikeNet';...
    'Step 3 - Computing Features', 'step3_computeFeatures';...
    'Step 4 - Eliminating non-spikes with boosting', 'step4_eliminateFPwithBoosting';...
    'Step 5 - GUI SpikeNet with BGR', 'step5_GUI_spikenet_with_bgr';...
    'Step 6 - Parsing Spikes', 'step6_parseSpikes';...
    'Step 7 - Prelabelling GUI', 'step7_preLabellingGUI';...
